...
/**
 * Which photo aspect each archetype needs. The photo is a background asset with
 * a mandated empty region, so requesting the wrong aspect and cover-cropping it
 * would crop away the very negative space the copy needs.
 */
export const ARCHETYPE_PHOTO_SHAPE: Record<PosterArchetype, PosterPhotoShape> = {
  scrim: 'portrait',
  diagonal: 'portrait',
  bands: 'landscape',
  curve: 'landscape',
