...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      'h-9 whitespace-nowrap px-2.5 text-left align-middle text-[11px] font-semibold uppercase tracking-wider text-muted-foreground sm:px-3',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td ref={ref} className={cn('px-2.5 py-2 align-middle sm:px-3 sm:py-2.5', className)} {...props} />
));
