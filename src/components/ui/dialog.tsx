...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      // `bg-scrim`, not `bg-foreground`: --foreground inverts with the theme, so
      // a foreground-based overlay becomes a near-white wash in dark mode. The
      // scrim token is deliberately fixed-dark in both themes.
